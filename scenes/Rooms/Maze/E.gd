...
onready var _to_front = preload("res://scenes/Rooms/Maze/E1.tscn")
#onready var _to_left = preload("res://scenes/Rooms/Maze/B1.tscn")
onready var _to_right = preload("res://scenes/Rooms/Maze/F.tscn")
onready var _to_back = preload("res://scenes/Rooms/Maze/D.tscn")
