...
onready var _to_left = preload("res://scenes/Rooms/Maze/D.tscn")
onready var _to_right = preload("res://scenes/Rooms/Maze/C1.tscn")
onready var _to_back = preload("res://scenes/Rooms/Maze/B.tscn")
